...
from utils.function import train, validate, train_adapt
...
def main():
    ...
    dis_lr = 1e-4
    optimizer_dis = torch.optim.Adam(model_dis.parameters(), lr=dis_lr, betas=(0.9, 0.99))
    ...
    for epoch in range(last_epoch, real_end):
        ...
        train_adapt(config, epoch, config.TRAIN.END_EPOCH,
                  epoch_iters, config.TRAIN.LR, num_iters,
                  trainloader, optimizer, model, writer_dict, targetloader, optimizer_dis, model_dis)
